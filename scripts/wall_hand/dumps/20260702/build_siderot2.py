...
OUT = r"C:/Dev/Sanjuk-Unreal/scripts/wall_hand/dumps/20260702/build_siderot2_result.txt"
L = []
...
try:
    ...
    ident = "(Rotation=(X=-0.500000,Y=0.000000,Z=0.000000,W=0.866025),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000))"
