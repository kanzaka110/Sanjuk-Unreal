...
JOBS = [
    ("now_bp.json",    BP,  "UpdateWallHandIK"),
    ("now_ik.json",    LAY, "IK"),
    ("now_leg.json",   LAY, "EventGraph"),
    ("now_alpha.json", ABP, "SetSmoothedWallHandAlpha"),
    ("now_data.json",  ABP, "SetWallHandData"),
    ("now_front.json", ABP, "SetWallHandFront"),
    ("now_allow.json", ABP, "IsWallHandAllowed"),
    ("now_state.json", ABP, "GetWallHandState"),
    ("now_updvar.json",ABP, "UpdateVariables"),
]
