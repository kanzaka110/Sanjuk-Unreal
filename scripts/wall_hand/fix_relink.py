...
OUT=r"C:\Users\SHIFTUP\AppData\Local\Temp\claude\C--Dev-Sanjuk-Unreal\afc97dd6-1b24-41ae-b1e1-10943ed3c5d4\scratchpad\fix_relink.txt"
...
try:
    ...
    ok=ctrl.add_link("TgtXf.Result","Rel.Global"); w(f"link TgtXf.Result->Rel.Global ({ok})")
