...
OUT = "C:/Users/SHIFTUP/AppData/Local/Temp/claude/zbias_save.json"
...
try:
    ...
    c.set_pin_default_value("HandZBiasL.B", "(X=0.0,Y=0.0,Z=4.0)", False)
    c.set_pin_default_value("HandZBiasR.B", "(X=0.0,Y=0.0,Z=4.0)", False)
    log["zbias"] = "4.0"
    bp.recompile_vm()
