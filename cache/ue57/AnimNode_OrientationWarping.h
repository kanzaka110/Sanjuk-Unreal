...
// Path: Engine/Plugins/Animation/AnimationWarping/Source/Runtime/Public/BoneControllers/AnimNode_OrientationWarping.h
// Cached: 2026-04-16
// ============================================================
...
private:
	...
	struct FOrientationWarpingSpineBoneData
	{
		...
		{
			inline bool operator()(const FOrientationWarpingSpineBoneData& A, const FOrientationWarpingSpineBoneData& B) const
			{
